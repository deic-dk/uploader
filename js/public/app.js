...
(function() {
  ...
  angular.module('Uploader', ['OC']).config([
    '$provide', '$interpolateProvider', function($provide, $interpolateProvider) {
      ...
      Config.routes = {
        saveNameRoute: 'uploader_ajax_setsystemvalue',
        getNameRoute: 'uploader_ajax_getsystemvalue'
      };
...
(function() {
  ...
  angular.module('Uploader').filter('leetIt', function() {
...
(function() {
  ...
  angular.module('Uploader').factory('UploaderRequest', [
    '$http', 'Config', '_UploaderRequest', 'Publisher', function($http, Config, _UploaderRequest, Publisher) {
...
(function() {
  ...
  angular.module('Uploader').factory('_UploaderRequest', [
    '_Request', function(_Request) {
      var UploaderRequest;
      UploaderRequest = (function(_super) {

        __extends(UploaderRequest, _super);

        function UploaderRequest($http, Config, Publisher) {
          UploaderRequest.__super__.constructor.call(this, $http, Config, Publisher);
        }

        UploaderRequest.prototype.saveName = function(route, name) {
          var data;
          data = {
            somesetting: name
          };
        ...
        UploaderRequest.prototype.getName = function(route, scope) {
          var success;
...
(function() {
  ...
  angular.module('Uploader').factory('_ItemModel', function() {
    var ItemModel;
    ItemModel = (function() {
...
(function() {
  ...
  angular.module('Uploader').factory('_ExampleController', function() {
...
(function() {
  ...
  angular.module('Uploader').controller('ExampleController', [
    '$scope', 'Config', 'UploaderRequest', '_ExampleController', 'ItemModel', function($scope, Config, UploaderRequest, _ExampleController, ItemModel) {
